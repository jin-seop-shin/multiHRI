...
def get_arguments(additional_args=[]):
    ...
    parser.add_argument('--ADV-seed', type=int, default=68, help='seed used in train_helper')
    parser.add_argument('--ADV-h-dim', type=int, default=512, help='hidden dimension used in train_helper')
