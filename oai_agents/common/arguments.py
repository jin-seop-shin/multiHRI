...
def get_arguments(additional_args=[]):
    ...
    parser.add_argument('--for-evaluation', type=bool, default=True, help="The trained agents are used for evaluating other agents. Please note that seeds and h_dim are different when agents are trained for evaluating others.)")
